...
\begin{figure}[!ht]
	...
	\caption[Escoamento supersônico na base de um projetil com \textit{Base Bleed} \cite{Mathur&Dutton1996}]{Escoamento supersônico na base de um projetil com \textit{Base Bleed} \cite{Mathur&Dutton1996}.}
...
\begin{figure}[!ht]
	...
	\caption[Pressão na base por fluxo de massa \cite{Andersson1976}]{Pressão na base por fluxo de massa \cite{Andersson1976}.}
...
\begin{figure}[!ht]
	...
	\caption[Coeficiente de Arrasto em função do número de Mach para um projétil calibre 120mm obtido por testes de tiro, com ou sem \textit{Base Bleed} \cite{Andersson1976}]{Coeficiente de Arrasto em função do número de Mach para um projétil calibre 120mm obtido por testes de tiro, com ou sem \textit{Base Bleed} \cite{Andersson1976}}
