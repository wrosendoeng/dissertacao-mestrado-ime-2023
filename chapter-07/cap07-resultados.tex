...
\begin{figure}[!ht]
	...
	\begin{subfigure}[b]{0.47\textwidth}
    	...
    	\caption{Saída do bocal - \(\phi_{m}_{BB}\) = \qty{25,4}{\millimetre}}
	...
	\begin{subfigure}[b]{0.47\textwidth}
    	...
    	\caption{Saída do bocal - \(\phi_{m}_{BB}\) = \qty{50,8}{\millimetre}}
...
\begin{figure}[!ht]
	...
	\begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Contornos de Pressão - \(\Dot_{m}_{BB}\) = \qty{0,015}{\kilogram\per\second}}
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Contornos de Pressão - \(\Dot_{m}_{BB}\) = \qty{0,030}{\kilogram\per\second}}
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Cont. de Velocidade - \(\Dot_{m}_{BB}\) = \qty{0,015}{\kilogram\per\second}}
	...
	\begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Cont. de Velocidade - \(\Dot_{m}_{BB}\) = \qty{0,030}{\kilogram\per\second}}
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Linhas de corrente - \(\Dot_{m}_{BB}\) = \qty{0,015}{\kilogram\per\second}}
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Linhas de corrente - \(\Dot_{m}_{BB}\) = \qty{0,030}{\kilogram\per\second}}
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Contornos de Pressão - \(\Dot_{m}_{BB}\) = \qty{0,060}{\kilogram\per\second}}
	...
	\begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Cont. de Velocidade - \(\Dot_{m}_{BB}\) = \qty{0,060}{\kilogram\per\second}}
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Linhas de Corrente - \(\Dot_{m}_{BB}\) = \qty{0,060}{\kilogram\per\second}}
...
\begin{figure}[!ht]
	...
	\caption{Influência da temperatura do \textit{Base Bleed} sobre o coeficiente de arrasto com \(\Dot_{m}_{BB}\) = \qty{0,060}{\kilogram\per\second}}
...
Conforme foi citado anteriormente, o modelo Spalart-Allmaras \cite{Spalart1992} foi manejado para atestar a eficiência de outra técnica RANS para descrição da turbulência além do que foi proposto por \citeauthor{Menter1994TwoequationET}. A comparação foi realizada somente para os seguintes valores na condição de contorno \textit{base bleed inlet}: - \(\phi_{m}_{BB}\) = \qty{50,8}{\millimetre}, \(T_{BB} = \qty{2306,15}{\kelvin}\) e \(\Dot_{m}_{BB}\) = \qty{0,060}{\kilogram\per\second}.
