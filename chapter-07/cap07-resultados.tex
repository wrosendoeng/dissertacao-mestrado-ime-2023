...
\begin{figure}[!ht]
	...
	\begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Contornos de Pressão - $\Dot{m}_{BB} = \qty[per-mode=symbol]{0,015}{\kilogram\per\second}$}
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Contornos de Pressão - $\Dot{m}_{BB} = \qty[per-mode=symbol]{0,030}{\kilogram\per\second}$}
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Contornos de Velocidade - $\Dot{m}_{BB} = \qty[per-mode=symbol]{0,015}{\kilogram\per\second}$}
	...
	\begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Contornos de Velocidade - $\Dot{m}_{BB} = \qty[per-mode=symbol]{0,030}{\kilogram\per\second}$}
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Linhas de corrente - $\Dot{m}_{BB} = \qty[per-mode=symbol]{0,015}{\kilogram\per\second}$}
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Linhas de corrente - $\Dot{m}_{BB} = \qty[per-mode=symbol]{0,030}{\kilogram\per\second}$}
        \label{fig:corrente-velocidade-bb-1pol-vazao0030}
    \end{subfigure}
	\caption{Projetil sob diferentes condições de vazão mássica sob regime M = \num{2,0} e diâmetro de saída do \textit{Base Bleed} de \qty{1}{\polegada} $\left(\phi_{BB} = \qty{25,4}{\millimetre}\right)$}
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Contornos de Velocidade - $\Dot{m}_{BB} = \qty{0,030}{\kilogram\per\second}$}
	...
	\begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Contornos de Velocidade - $\Dot{m}_{BB} = \qty{0,060}{\kilogram\per\second}$}
    ...
    \end{subfigure}
	\caption{Projetil sob diferentes condições de vazão mássica sob regime M = \num{2,0} e diâmetro de saída do \textit{Base Bleed} de 2 polegadas ($\phi_{BB} = \qty{50,8}{\millimetre}$)}
...
\begin{figure}[!ht]
    ...
    \end{subfigure}
    \caption{Projetil sob diferentes condições de vazão mássica sob regime M = \num{2,0}, diâmetro de saída do \textit{Base Bleed} de 2 polegadas ($\phi_{BB} = \qty{50,8}{\millimetre}$) e Temperatura prescrita ($T_{BB} = \qty{1500}{\kelvin}$)}
...
\begin{figure}[!ht]
	...
	\begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Trajetória com QE = \qty{711}{\milliradian} ($\phi_{BB} = \qty{25,4}{\millimetre}$)}
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Trajetória com QE = \qty{800}{\milliradian} ($\phi_{BB} = \qty{25,4}{\millimetre}$)}
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Trajetória com QE = \qty{711}{\milliradian} ($\phi_{BB} = \qty{50,8}{\millimetre}$)}
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        ...
        \caption{Trajetória com QE = \qty{800}{\milliradian} ($\phi_{BB} = \qty{50,8}{\millimetre}$)}
