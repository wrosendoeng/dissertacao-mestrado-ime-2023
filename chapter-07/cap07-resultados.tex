...
Para averiguar a qualidade do código desenvolvido em MATLAB®, foram simuladas as condições ativa e inerte da munição (com e sem \textit{Base Bleed}) com ângulos de elevação (QE) entre \qtylist{440;1250}{\milliradian} (de \qtyrange{25}{72}{\degree}). A Figura \ref{fig:trajetoria-validacao} demonstra o projetil \qty{155}{\millimetre} sendo disparado.
