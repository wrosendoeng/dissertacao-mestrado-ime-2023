...
O software autoral para a predição de trajetória também serviu para atestar incongruências existentes no código utilizado por \citeauthor{Rosendo2020} para suas simulações. Tais resultados podem ser observados na Figura \ref{fig:trajetoria-validacao}, em que se demonstra disparos de um projetil \qty{114}{\millimetre} com ângulos de elevação (QE) entre \qtylist{440;1250}{\milliradian} (de \qtyrange{25}{72}{\degree}).
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}[!ht]{\textwidth}
        ...
        \label{fig:trajetoria-avaliacao-sembasebleed}
    \end{subfigure}
    \caption{Projetil com diferentes ângulos de elevação}
	\label{fig:trajetoria-validacao}
\end{figure}

Contudo, o simulador desenvolvido neste trabalho comprovou que, mesmo não sendo utilizados em suas respectivas equações \ref{eq:liftMPM} e \ref{eq:baseMPM}, os valores finais de trajetória foram considerados com boa precisão, se comparados aos lançamentos reais de projetis.
