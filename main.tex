...
\renewcommand*{\cftqzzuadroaftersnum}{\hfill--\hfill}
...
\inputpdf{ficha_catalog_Wallace.pdf}
...
\include{chapter-01/cap01-intro}
\include{chapter-02/cap02-revisaoteorica}
\include{chapter-03/cap03-metodosnumericos}
\include{chapter-04/cap04-turbulencia}
\include{chapter-05/cap05-trajetoria}
\include{chapter-06/cap06-estudoproposto}
\include{chapter-07/cap07-resultados}
\include{chapter-08/cap08-consideracoesfinais}
...
\begin{apendicesenv}
    \partapendices
    \include{appendices/apendice-A-cd-sem-bb}
    \include{appendices/apendice-B-cd-temp-300K}
    \include{appendices/apendice-C-cd-temp-1500K}
    \include{appendices/apendice-D-cd-temp-2306K-1pol-vazao0015}
    \include{appendices/apendice-E-cd-temp-2306K-1pol-vazao0030}
    \include{appendices/apendice-F-cd-temp-2306K-2pol-vazao0030}
    \include{appendices/apendice-G-cd-temp-2306K-2pol-vazao0060}
\end{apendicesenv}
% ---
